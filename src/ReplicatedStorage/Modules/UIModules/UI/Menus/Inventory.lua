...
function module:Show()
	if self.UI.Menus.Settings:IsVisible() or self.UI.Menus.Auras:IsVisible() or self.UI.Menus.Info:IsVisible() or self.UI.Menus.Missions:IsVisible() or self.UI.Menus.FastTravel:IsVisible() then
...
function module:init()
	...
	self.MenuFrame = self.ScreenGui:WaitForChild("Canvas"):WaitForChild("Inventory")
	self.PageLocked = false
	self.IsEnabled = true
	self.IsOpen = false
	
	self.PlayerGui:WaitForChild("HUD"):WaitForChild("Canvas"):WaitForChild("List"):WaitForChild("Items"):WaitForChild("Items").Activated:Connect(function()
