...
function module:Show()
	if self.UI.Menus.Inventory:IsVisible() or self.UI.Menus.Auras:IsVisible() or self.UI.Menus.Info:IsVisible() or self.UI.Menus.Missions:IsVisible() or self.UI.Menus.FastTravel:IsVisible() then
...
function module:init()
	...
	self.MenuFrame = self.ScreenGui:WaitForChild("Canvas"):WaitForChild("Settings")
	self.PageLocked = false
	self.IsEnabled = true
	self.IsOpen = false
	
	self.PlayerGui:WaitForChild("HUD"):WaitForChild("Canvas"):WaitForChild("List"):WaitForChild("Settings"):WaitForChild("Settings").Activated:Connect(function()
