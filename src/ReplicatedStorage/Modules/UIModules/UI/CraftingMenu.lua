...
function module:Show()
	...
	self.UI.Menus.Info:Hide()
	self.UI.Menus.Inventory.IsEnabled = false
	self.UI.Menus.Settings.IsEnabled = false
	self.UI.Menus.Auras.IsEnabled = false
	self.UI.Menus.Missions.IsEnabled = false
	self.UI.Menus.Info.IsEnabled = false
	
	self.ScreenGui.Enabled = true
end

function module:Hide()
	self.UI.Menus.Inventory.IsEnabled = true
	self.UI.Menus.Settings.IsEnabled = true
	self.UI.Menus.Auras.IsEnabled = true
	self.UI.Menus.Missions.IsEnabled = true
	self.UI.Menus.Info.IsEnabled = true
...
function module:init()
	...
	self.ScreenGui = self.PlayerGui:WaitForChild("SpamtonTrades")
