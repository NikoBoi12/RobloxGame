...
for i=1, Max do
	...
	task.defer(function()
		while true do
			local Tween = TweenService:Create(Clone.Image, TweenInfo.new(6, Enum.EasingStyle.Linear), {ImageRectOffset = Vector2.new(512, 0)})
			Tween:Play()
			Tween.Completed:Wait()
			Clone.Image.ImageRectOffset = Vector2.new(0, 0)
		end
	end)
end
