...
SwagText.AnimateText("<wave>this is some <rainbow>text thats gonna</rainbow> warp for a hot while, okay ??</wave>", script.Parent.Frame, 0, nil, "fade sizeright shake", 0)
--SwagText.ClearText(script.Parent.Frame)
